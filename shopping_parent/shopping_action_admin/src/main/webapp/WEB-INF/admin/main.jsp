    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#product-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/productManager/findAll");
            });
            $("#user-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/customerManager/findAll");
            });
            $("#manager-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/systemerManager/findAll");
            });
        });
    </script>
</head>
