    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#product-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/productManager/productManager");
            });
            $("#user-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/customerManager/customerManager");
            });
            $("#manager-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/sysuserManager/sysuserManager");
            });
        });
    </script>
</head>
        ...
        <div class="container-flude flude-cc" id="a">
            <div class="row user-setting">
                ...
                <div class="col-xs-10" id="userPanel">
                    <iframe id="frame-id" src="${pageContext.request.contextPath}/productType/findAll" width="100%" height="100%" frameborder="0" scrolling="no">
                    </iframe>
                </div>
